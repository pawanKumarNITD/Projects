...
// (DO NOT EDIT: machine generated header) 'System.Bindings.EvalProtocol.pas' rev: 35.00 (Windows)
...
public:
	...
	#else
	operator IChild*(void) { return (IChild*)&__IChild; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	...
	#else
	operator System::IInterface*(void) { return (System::IInterface*)&__IChild; }
	#endif
