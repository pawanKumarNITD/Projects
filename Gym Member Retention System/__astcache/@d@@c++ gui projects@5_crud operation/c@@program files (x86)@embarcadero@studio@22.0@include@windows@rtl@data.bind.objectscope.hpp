...
// (DO NOT EDIT: machine generated header) 'Data.Bind.ObjectScope.pas' rev: 35.00 (Windows)
...
//-- user supplied -----------------------------------------------------------
#pragma link "Data.Bind.ObjectScope"
...
private:
	void *__IScopeRecordControlUpdator;	// Data::Bind::Components::IScopeRecordControlUpdator 
...
public:
	...
	operator Data::Bind::Components::_di_IScopeRecordControlUpdator()
	{
		Data::Bind::Components::_di_IScopeRecordControlUpdator intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Data::Bind::Components::IScopeRecordControlUpdator*(void) { return (Data::Bind::Components::IScopeRecordControlUpdator*)&__IScopeRecordControlUpdator; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
...
#ifndef _WIN64
typedef System::TMetaClass* TGeneratorBindFieldDefsClass;
#else /* _WIN64 */
...
protected:
#ifndef _WIN64
	void __fastcall PostFields(System::DynamicArray<TBindSourceAdapterField*> AFields);
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual void __fastcall DoBeforePostFields(System::DynamicArray<TBindSourceAdapterField*> AFields);
	virtual void __fastcall DoAfterPostFields(System::DynamicArray<TBindSourceAdapterField*> AFields);
#else /* _WIN64 */
...
protected:
	#define TBindSourceAdapterReadField__1_sMemberName L"Value"
...
private:
#ifndef _WIN64
	System::DynamicArray<System::Rtti::TValue> FValues;
#else /* _WIN64 */
...
#ifndef _WIN64
	__fastcall TTypedListValueGeneratorDelegate__1(const TGeneratorOptions AOptions, const System::DynamicArray<T> AValuesList)/* overload */;
	__fastcall TTypedListValueGeneratorDelegate__1(const TGeneratorOptions AOptions, const System::DynamicArray<T> AValuesList, const _di_TValueGeneratorOnGetValue AOnGetValue)/* overload */;
#else /* _WIN64 */
...
private:
#ifndef _WIN64
	System::DynamicArray<T> __fastcall ConvertArray(System::DynamicArray<T1> AArray);
#else /* _WIN64 */
...
public:
#ifndef _WIN64
	__fastcall TTypedListValueGeneratorDelegate2__2(TGeneratorOptions AOptions, System::DynamicArray<T1> AValuesList);
#else /* _WIN64 */
...
#ifndef _WIN64
typedef System::TMetaClass* TValueGeneratorClass;
#else /* _WIN64 */
