...
// (DO NOT EDIT: machine generated header) 'Data.Bind.Components.pas' rev: 35.00 (Windows)
...
__published:
	...
	__property AutoActivate = {default=1};
	__property Managed = {default=1};
	__property NotifyOutputs = {default=0};
	__property OnAssigningValue;
	__property OnAssignedValue;
	__property OnEvalError;
	__property OnActivating;
...
protected:
	...
	void __fastcall UpdateList();
	HIDESBASE _di_IScopeRecordEnumerator __fastcall GetEnumerator(const System::UnicodeString AMemberName, bool ABuffered)/* overload */;
	HIDESBASE _di_IScopeRecordEnumerator __fastcall GetEnumerator(const System::UnicodeString AMemberName, int ABufferCount)/* overload */;
...
private:
	void *__IScopeRecordControlUpdator;	// IScopeRecordControlUpdator 
	void *__IScopeRecordEnumerable;	// IScopeRecordEnumerable 
	void *__IScopeRecordEnumerableBuffered;	// IScopeRecordEnumerableBuffered 
	void *__IBindListUpdate;	// IBindListUpdate 
...
public:
	...
	operator _di_IScopeRecordControlUpdator()
	{
		_di_IScopeRecordControlUpdator intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator IScopeRecordControlUpdator*(void) { return (IScopeRecordControlUpdator*)&__IScopeRecordControlUpdator; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	...
	operator _di_IScopeRecordEnumerableBuffered()
	{
		_di_IScopeRecordEnumerableBuffered intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator IScopeRecordEnumerableBuffered*(void) { return (IScopeRecordEnumerableBuffered*)&__IScopeRecordEnumerableBuffered; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {01EED9E9-F0BD-4752-A6BA-F79EF46ABE55}
	operator _di_IBindListUpdate()
...
private:
	...
	bool __fastcall GetManaged();
	bool __fastcall GetNotifyOutputs();
	void __fastcall SetManaged(const bool Value);
	void __fastcall SetNotifyOutputs(const bool Value);
...
public:
	...
	__property bool NotifyOutputs = {read=GetNotifyOutputs, write=SetNotifyOutputs, default=0};
	__property bool Track = {read=GetTrack, write=SetTrack, default=0};
};
...
public:
	...
	static const int IDIteratorLinkObserver = int(5);
