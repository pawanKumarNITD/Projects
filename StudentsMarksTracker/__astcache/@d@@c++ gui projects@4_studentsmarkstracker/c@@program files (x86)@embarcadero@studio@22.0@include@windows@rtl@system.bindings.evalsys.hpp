...
// (DO NOT EDIT: machine generated header) 'System.Bindings.EvalSys.pas' rev: 35.00 (Windows)
...
public:
	...
	/* {System_Generics_Collections}TList<System_TGUID>.Create */ inline __fastcall TCollectionInterfacesTracker(const GUID *Values, const int Values_High)/* overload */ : System::Generics::Collections::TList__1<GUID>(Values, Values_High) { }
...
public:
	...
	private:
		...
		System::Generics::Collections::TList__1<System::_di_IInterface>::TEnumerator* FListEnumerator;
...
public:
	...
	private:
		...
		System::Generics::Collections::TDictionary__2<System::UnicodeString,System::_di_IInterface>::TValueEnumerator* FMapEnumerator;
